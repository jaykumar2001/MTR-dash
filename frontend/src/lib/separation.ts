...
// Used by NetworkMap to keep hop-node boxes from ever overlapping, displacing them
// the minimum distance so a user's dragged layout stays as close to itself as possible.
